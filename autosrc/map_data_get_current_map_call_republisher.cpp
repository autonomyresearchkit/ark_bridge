...
ROSToLCMRepublisher::ROSToLCMRepublisher(ros::NodeHandle& n, lcm::LCM* lh) 
{
    ...
    // Subscribers
    ros_sub = nh.subscribe<ark_bridge::Empty>("map_data_get_current_map_call", 10, &ROSToLCMRepublisher::rosCallback, this);
};

ROSToLCMRepublisher::~ROSToLCMRepublisher() 
{    
    ROS_INFO("map_data_get_current_map_call ROSToLCMRepublisher destructor.");
}
...
void ROSToLCMRepublisher::rosCallback(const ark_bridge::Empty::ConstPtr& ros_msg)
{
    ...
    lcm_handle->publish("map_data_get_current_map_call", lcm_msg);
};
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "map_data_get_current_map_call_ros2lcm");
    ros::NodeHandle nh;   
