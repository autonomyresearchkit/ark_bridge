...
///////////////////////////////////////////////////////////////////////
//
// Source message:    OccupancyGrid.msg
...
LCMToROSRepublisher::LCMToROSRepublisher(ros::NodeHandle& n) 
{
    ...
    // Publisher/s
    ros_pub = nh.advertise<ark_bridge::OccupancyGrid>("map_data_map", 10);
    ROS_DEBUG("map_data_map publisher created");
};

LCMToROSRepublisher::~LCMToROSRepublisher() 
{    
    ROS_INFO("map_data_map LCMToROSRepublisher destructor.");
}
        ...
        const ark::OccupancyGrid* msg)
{
    ...
    const ark_bridge::OccupancyGrid * new_ros_msg = reinterpret_cast<const ark_bridge::OccupancyGrid *>(msg);
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "map_data_map_republish");
    ros::NodeHandle nh;   

    LCMToROSRepublisher handlerObject(nh);
    lcm.subscribe("map_data_map", &LCMToROSRepublisher::lcmCallback, &handlerObject);
