...
ROSToLCMRepublisher::ROSToLCMRepublisher(ros::NodeHandle& n, lcm::LCM* lh) 
{
    ...
    // Subscribers
    ros_sub = nh.subscribe<ark_bridge::PoseWithCovarianceStamped>("slam_set_initial_pose_call", 10, &ROSToLCMRepublisher::rosCallback, this);
};

ROSToLCMRepublisher::~ROSToLCMRepublisher() 
{    
    ROS_INFO("slam_set_initial_pose_call ROSToLCMRepublisher destructor.");
}

void ROSToLCMRepublisher::rosCallback(const ark_bridge::PoseWithCovarianceStamped::ConstPtr& ros_msg)
{
    const ark::PoseWithCovarianceStamped* lcm_msg = reinterpret_cast<const ark::PoseWithCovarianceStamped*>( ros_msg.get() );
    lcm_handle->publish("slam_set_initial_pose_call", lcm_msg);
};
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "slam_set_initial_pose_call_ros2lcm");
    ros::NodeHandle nh;   
