...
///////////////////////////////////////////////////////////////////////
//
// Source message:    StringArray.msg
...
LCMToROSRepublisher::LCMToROSRepublisher(ros::NodeHandle& n) 
{
    ...
    // Publisher/s
    ros_pub = nh.advertise<ark_bridge::StringArray>("map_data_list_maps_response", 10);
    ROS_DEBUG("map_data_list_maps_response publisher created");
};

LCMToROSRepublisher::~LCMToROSRepublisher() 
{    
    ROS_INFO("map_data_list_maps_response LCMToROSRepublisher destructor.");
}
        ...
        const ark::StringArray* msg)
{
    ...
    const ark_bridge::StringArray * new_ros_msg = reinterpret_cast<const ark_bridge::StringArray *>(msg);
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "map_data_list_maps_response_republish");
    ros::NodeHandle nh;   

    LCMToROSRepublisher handlerObject(nh);
    lcm.subscribe("map_data_list_maps_response", &LCMToROSRepublisher::lcmCallback, &handlerObject);
