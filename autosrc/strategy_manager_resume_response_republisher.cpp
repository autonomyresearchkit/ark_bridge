...
///////////////////////////////////////////////////////////////////////
//
// Source message:    PauseControlResponse.msg
...
#include "ark/PauseControlResponse.hpp"
...
class LCMToROSRepublisher
{
    public:
        ...
        void lcmCallback(const lcm::ReceiveBuffer* rbuf,
                ...
                const ark::PauseControlResponse* msg);
...
LCMToROSRepublisher::LCMToROSRepublisher(ros::NodeHandle& n) 
{
    ...
    // Publisher/s
    ros_pub = nh.advertise<ark_bridge::PauseControlResponse>("strategy_manager_resume_response", 10);
    ROS_DEBUG("strategy_manager_resume_response publisher created");
};

LCMToROSRepublisher::~LCMToROSRepublisher() 
{    
    ROS_INFO("strategy_manager_resume_response LCMToROSRepublisher destructor.");
}
        ...
        const ark::PauseControlResponse* msg)
{
    ...
    const ark_bridge::PauseControlResponse * new_ros_msg = reinterpret_cast<const ark_bridge::PauseControlResponse *>(msg);
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "strategy_manager_resume_response_republish");
    ros::NodeHandle nh;   

    LCMToROSRepublisher handlerObject(nh);
    lcm.subscribe("strategy_manager_resume_response", &LCMToROSRepublisher::lcmCallback, &handlerObject);
