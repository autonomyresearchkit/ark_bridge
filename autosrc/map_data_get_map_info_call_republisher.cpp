...
ROSToLCMRepublisher::ROSToLCMRepublisher(ros::NodeHandle& n, lcm::LCM* lh) 
{
    ...
    // Subscribers
    ros_sub = nh.subscribe<ark_bridge::String>("map_data_get_map_info_call", 10, &ROSToLCMRepublisher::rosCallback, this);
};

ROSToLCMRepublisher::~ROSToLCMRepublisher() 
{    
    ROS_INFO("map_data_get_map_info_call ROSToLCMRepublisher destructor.");
}
...
void ROSToLCMRepublisher::rosCallback(const ark_bridge::String::ConstPtr& ros_msg)
{
    ...
    lcm_handle->publish("map_data_get_map_info_call", lcm_msg);
};
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "map_data_get_map_info_call_ros2lcm");
    ros::NodeHandle nh;   
