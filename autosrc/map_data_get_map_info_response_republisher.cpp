...
///////////////////////////////////////////////////////////////////////
//
// Source message:    MapInfoResponse.msg
...
#include "ark/MapInfoResponse.hpp"
...
LCMToROSRepublisher::LCMToROSRepublisher(ros::NodeHandle& n) 
{
    ...
    // Publisher/s
    ros_pub = nh.advertise<ark_bridge::MapInfoResponse>("map_data_get_map_info_response", 10);
    ROS_DEBUG("map_data_get_map_info_response publisher created");
};

LCMToROSRepublisher::~LCMToROSRepublisher() 
{    
    ROS_INFO("map_data_get_map_info_response LCMToROSRepublisher destructor.");
}
        ...
        const ark::MapInfoResponse* msg)
{
    ...
    const ark_bridge::MapInfoResponse * new_ros_msg = reinterpret_cast<const ark_bridge::MapInfoResponse *>(msg);
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "map_data_get_map_info_response_republish");
    ros::NodeHandle nh;   

    LCMToROSRepublisher handlerObject(nh);
    lcm.subscribe("map_data_get_map_info_response", &LCMToROSRepublisher::lcmCallback, &handlerObject);
