...
#ifndef __ark_Transform_hpp__
#define __ark_Transform_hpp__

#include "ark/Vector3.hpp"
#include "ark/Quaternion.hpp"
...
{
    public:
        ark::Vector3 translation;

        ark::Quaternion rotation;
...
uint64_t Transform::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x1275bd1ccbdaf47fLL +
         ark::Vector3::_computeHash(&cp) +
         ark::Quaternion::_computeHash(&cp);
